...
echo -e "${GREEN}==============================================================================${NC}"
echo -e "  🌐 Dashboard URL (HTTPS):  https://${SERVER_IP}/"
echo -e "  🌐 Dashboard URL (HTTP):   http://${SERVER_IP}/"
echo -e "  🏥 Health Check Endpoint:  https://${SERVER_IP}/health"
echo -e "  📊 Status verification:    https://${SERVER_IP}/status"
echo -e "  📖 Swagger API Docs:       https://${SERVER_IP}/docs"
echo -e "  📜 OpenAPI YAML Spec:      https://${SERVER_IP}/openapi.yaml"
echo -e "${GREEN}==============================================================================${NC}"
